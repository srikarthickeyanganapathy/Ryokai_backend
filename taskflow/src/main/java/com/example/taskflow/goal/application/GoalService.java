package com.example.taskflow.goal.application;

import com.example.taskflow.goal.domain.Goal;
import com.example.taskflow.goal.domain.KeyResult;
import com.example.taskflow.organization.core.domain.Organization;
import com.example.taskflow.user.domain.User;
import com.example.taskflow.goal.dto.GoalDTOs.*;
...
public class GoalService {
    ...
    public List<GoalResponseDTO> getGoals(Long orgId, User user) {
        ...
        if (user != null && !user.isSuperAdmin() && !user.isMemberOf(org)) {
            throw new com.example.taskflow.shared.exception.UnauthorizedActionException("You are not a member of this organization.");
        }
