 ...
 * <p>Evaluation order:
 * <ol>
 *   <li>DENY override â†’ immediately deny, skip role checks</li>
 *   <li>GRANT override â†’ skip role checks, proceed to policy evaluation</li>
 *   <li>No override â†’ fall through to role-based evaluation</li>
 * </ol>
 */
@Entity
