...
public class PersonalTaskStrategy implements TaskLifecycleStrategy, TaskScopeBehavior {
    ...
    private final com.example.taskflow.crew.infrastructure.persistence.CrewMemberRepository crewMemberRepository;

    public PersonalTaskStrategy(com.example.taskflow.crew.infrastructure.persistence.CrewMemberRepository crewMemberRepository) {
    ...
    public boolean canView(User u, Task t) {
        ...
        if (t.getProject() != null && t.getProject().getSharedCrews() != null) {
            for (com.example.taskflow.crew.domain.Crew crew : t.getProject().getSharedCrews()) {
