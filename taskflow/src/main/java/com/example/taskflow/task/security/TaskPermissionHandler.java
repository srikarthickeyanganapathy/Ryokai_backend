...
public class TaskPermissionHandler implements DomainPermissionHandler {
    ...
    private final com.example.taskflow.team.infrastructure.persistence.TeamRepository teamRepository;
    ...
    public TaskPermissionHandler(TaskRepository taskRepository,
                                 ...
                                 com.example.taskflow.team.infrastructure.persistence.TeamRepository teamRepository,
    ...
    private Long resolveOrgId(User user, com.example.taskflow.task.api.request.TaskRequestDTO request) {
    ...
    public boolean hasPermission(Authentication auth, User user, Object targetDomainObject, String permission) {
        ...
        if (targetDomainObject instanceof com.example.taskflow.task.api.request.TaskRequestDTO dto) {
            return hasCreatePrivilege(user, dto, permission);
        }
        if (targetDomainObject instanceof com.example.taskflow.task.api.request.BulkAssignRequestDTO dto) {
    ...
    private boolean hasCreatePrivilege(User user, com.example.taskflow.task.api.request.TaskRequestDTO request, String permission) {
        if ("TASK_CREATE".equals(permission) || "CREATE".equals(permission)) {
            com.example.taskflow.task.domain.model.TaskMode mode = com.example.taskflow.task.domain.model.TaskMode.ORG;
            if (request.isPersonal()) {
                mode = com.example.taskflow.task.domain.model.TaskMode.PERSONAL;
            } else if (request.getCrewId() != null) {
                mode = com.example.taskflow.task.domain.model.TaskMode.CREW;
            }
            
            if (mode == com.example.taskflow.task.domain.model.TaskMode.ORG) {
    ...
    private boolean hasPrivilege(User user, Task task, String permission) {
        ...
        // â”€â”€ 1. CREW and PERSONAL Workspaces â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ 2. ORGANIZATION Workspace â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
