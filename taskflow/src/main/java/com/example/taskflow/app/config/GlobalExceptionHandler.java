package com.example.taskflow.app.config;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.example.taskflow.security.exception.InvalidCredentialsException.class)
    public ResponseEntity<Object> handleInvalidCredentialsException(com.example.taskflow.security.exception.InvalidCredentialsException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.user.exception.UsernameConflictException.class)
    public ResponseEntity<Object> handleUsernameConflictException(com.example.taskflow.user.exception.UsernameConflictException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.task.exception.TaskNotFoundException.class)
    public ResponseEntity<Object> handleTaskNotFoundException(com.example.taskflow.task.exception.TaskNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.user.exception.UserNotFoundException.class)
    public ResponseEntity<Object> handleUserNotFoundException(com.example.taskflow.user.exception.UserNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.shared.exception.UnauthorizedActionException.class)
    public ResponseEntity<Object> handleUnauthorizedActionException(com.example.taskflow.shared.exception.UnauthorizedActionException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.organization.core.exception.OrganizationSuspendedException.class)
    public ResponseEntity<Object> handleOrganizationSuspendedException(com.example.taskflow.organization.core.exception.OrganizationSuspendedException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.crew.exception.CrewNotFoundException.class)
    public ResponseEntity<Object> handleCrewNotFoundException(com.example.taskflow.crew.exception.CrewNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.crew.exception.CrewFullException.class)
    public ResponseEntity<Object> handleCrewFullException(com.example.taskflow.crew.exception.CrewFullException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.crew.exception.CrewInviteExpiredException.class)
    public ResponseEntity<Object> handleCrewInviteExpiredException(com.example.taskflow.crew.exception.CrewInviteExpiredException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.example.taskflow.shared.exception.ResourceNotFoundException.class)
    public ResponseEntity<Object> handleResourceNotFoundException(com.example.taskflow.shared.exception.ResourceNotFoundException ex, HttpServletRequest request) {
