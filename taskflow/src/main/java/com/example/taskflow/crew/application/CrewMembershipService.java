...
public class CrewMembershipService {
    ...
    public CrewResponseDTO joinPublicCrew(Long crewId, User user) {
        ...
        if (crew.getVisibility() != com.example.taskflow.crew.domain.CrewVisibility.PUBLIC &&
            crew.getVisibility() != com.example.taskflow.crew.domain.CrewVisibility.PUBLIC_LINK) {
        ...
        if (!crewMemberRepository.existsByIdCrewIdAndIdUserId(crew.getId(), user.getId())) {
            ...
            notificationService.createAndSend(crew.getCreator(), user,
                com.example.taskflow.notification.event.NotificationEvent.ORG_MEMBER_JOINED,
    ...
    public CrewInviteDTO createPublicLinkInvite(Long crewId, User user) {
        ...
        if (crew.getVisibility() != com.example.taskflow.crew.domain.CrewVisibility.PUBLIC_LINK &&
            crew.getVisibility() != com.example.taskflow.crew.domain.CrewVisibility.PUBLIC) {
