...
public class CrewProjectService {
    ...
    public List<com.example.taskflow.project.dto.ProjectResponseDTO> getCrewProjects(Long crewId, User user) {
    ...
    @Transactional
    public com.example.taskflow.project.dto.ProjectResponseDTO shareProject(Long crewId, Long projectId, User user) {
        Crew crew = crewRepository.findById(crewId)
                .orElseThrow(() -> new ResourceNotFoundException("Crew not found"));
