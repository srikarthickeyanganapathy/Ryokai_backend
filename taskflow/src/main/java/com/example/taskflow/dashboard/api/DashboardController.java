package com.example.taskflow.dashboard.api;
...
public class DashboardController {
    ...
    public DashboardController(DashboardQueryService dashboardService, UserService userService) {
    ...
    public ResponseEntity<Page<ActivityEventDTO>> getActivityFeedForTask(
        ...
        // I need to update DashboardQueryService to have getActivityFeedForTask(taskId, user, pageable) 
        // that delegates to auditService, wait I didn't add it in DashboardQueryService yet. 
        // I will add it to DashboardQueryService next, or just call TaskAuditService directly here?
