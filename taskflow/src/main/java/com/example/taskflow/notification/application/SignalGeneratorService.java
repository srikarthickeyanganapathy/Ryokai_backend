...
public class SignalGeneratorService {
    ...
    public PriorityTier determineTier(NotificationEvent event) {
        return switch (event) {
            ...
            case TASK_ASSIGNED, TASK_DUE_SOON, TASK_OVERDUE, LEAVE_REQUESTED, EXIT_REQUESTED -> PriorityTier.NOTIFICATION;
            case TASK_COMMENTED, CHECKLIST_UPDATED, ORG_MEMBER_JOINED, TASK_SUBMITTED, TASK_APPROVED, TASK_REJECTED, DEPENDENCY_RESOLVED, LEAVE_APPROVED, LEAVE_REJECTED, LEAVE_CANCELLED, EXIT_APPROVED, EXIT_REJECTED, EXIT_CANCELLED -> PriorityTier.ACTIVITY;
