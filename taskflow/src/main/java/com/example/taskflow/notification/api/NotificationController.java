package com.example.taskflow.notification.api;
...
@RestController
@RequestMapping(value = "/api/v1/notifications", produces = org.springframework.http.MediaType.APPLICATION_JSON_VALUE)
